                                        ...
                                        const uuid_t p_uuidDestNugget)
{
    ...
    if ((msg = Message_CncCreate(MESSAGE_TYPE_REG_RESP, MESSAGE_VERSION_1, 0, p_uuidSourceNugget, p_uuidDestNugget)) == NULL)
        return NULL;
...
void
Message_CnC_RegResp_Setup(struct Message *msg)
{
    msg->destroy=Message_Destroy;
    msg->deserialize = Message_CnC_Deserialize_Empty;
    msg->serialize = Message_CnC_Serialize_Empty;
