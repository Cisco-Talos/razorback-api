...
#if 0
/** read the message header from a message
 * @param *p_pBuffer the message buffer.
 * @param p_pMesgHeader the message header
 * @return true on success false on error
 */
extern bool BinaryBuffer_Get_MessageHeader (struct BinaryBuffer *p_pBuffer,
                                            struct MessageHeader
                                            *p_pMesgHeader);

/** put the message header into a buffer
 * @param *p_pBuffer the message buffer.
 * @param p_pMesgHeader the message header
 * @return true on success false on error
 */
extern bool BinaryBuffer_Put_MessageHeader (struct BinaryBuffer *p_pBuffer,
                                            struct MessageHeader
                                            *p_pMesgHeader);
...
/** Puts an transfer ticket into a binary buffer
 * @param p_pBuffer the buffer
 * @param p_pTransferTicket the transfer ticket
 * @return true if ok, false if EFAULT
 */
extern bool BinaryBuffer_Put_TransferTicket (struct BinaryBuffer *p_pBuffer,
                                    struct TransferTicket *p_pTransferTicket);

/** Gets an transfer ticket from a binary buffer
 * @param p_pBuffer the buffer
 * @param p_pTransferTicket the transfer ticket
 * @return true if ok, false if EFAULT
 */
extern bool BinaryBuffer_Get_TransferTicket (struct BinaryBuffer *p_pBuffer,
                                    struct TransferTicket **p_pTransferTicket);
