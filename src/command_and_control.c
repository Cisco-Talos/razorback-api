...
CommandAndControl_DispatchCommand (struct RazorbackContext *p_pContext)
{
    ...
    case MESSAGE_TYPE_HELLO:
        ...
        CommandAndControl_PrintUuid (LOG_DEBUG, "%s: C&C Msg Dispatch: Nugget Type UUID: %s Desc: %s", __func__, 
                sg_ccmuMessage.mhHello.uuidNuggetType, UUID_TYPE_NUGGET_TYPE);
        CommandAndControl_PrintUuid (LOG_DEBUG, "%s: C&C Msg Dispatch: Application Type UUID: %s Desc: %s", __func__, 
    ...
    case MESSAGE_TYPE_REG_REQ:
        ...
        for (l_iDataTypeIttr = 0;
             ...
             l_iDataTypeIttr++)
        {
            CommandAndControl_PrintUuid (LOG_DEBUG, "%s: C&C Msg Dispatch: Data Type UUID: %s Desc: %s", __func__, 
