...
extern bool Thread_IsStopped (struct Thread *p_pThread);
extern void Thread_Stop (struct Thread *p_pThread);
extern void Thread_StopAndJoin (struct Thread *p_pThread);
extern void Thread_InterruptAndJoin (struct Thread *p_pThread);
...
extern int Thread_KeyCmp(void *a, void *id);
extern int Thread_Cmp(void *a, void *b);
