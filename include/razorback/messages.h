 ...
 */
SO_PUBLIC extern bool Message_Add_Header(
...
/**
 * Deserialize an empty message body.
 * @param message The message.
 * @return true on success, false on failure.
 */
...
/**
 * Serialize an empty message body.
 * @param message The message.
 * @return true on success, false on failure.
 */
 ...
 */
SO_PUBLIC extern struct Message * Message_Create_Directed(
    uint32_t type,
    uint32_t version,
    size_t msgSize,
    const uuid_t source,
 ...
 * @return A new message on success, NULL on failure.
 */
SO_PUBLIC extern struct Message * Message_Create_Broadcast(
    uint32_t type,
    uint32_t version,
    size_t msgSize,
    const uuid_t source
 ...
 * @param localities Array of locality values.
 * @return A new message on success,  NULL On failure.
 */
 ...
 * @param dispatcherId Dispatcher id UUID value.
 * @param sourceNugget the source.
 * @param nuggetType Nugget type UUID value.
 ...
 * @param sourceNugget the source.
 * @param sestNugget Sest nugget UUID value.
 ...
 * @return A new message on success,  NULL On failure.
 */
SO_PUBLIC extern struct Message * MessageBye_Initialize(const uuid_t sourceNugget);
 ...
 * @return A new message on success,  NULL On failure.
 */
SO_PUBLIC extern struct Message * MessageCacheClear_Initialize(const uuid_t sourceNugget);
 ...
 * @return A new message on success, NULL On failure.
 */
SO_PUBLIC struct Message * MessageReReg_Initialize(
    const uuid_t sourceNugget,
    const uuid_t destNugget
);
 ...
 * @param new_Ent_Flags New ent flags value.
 * @param old_SF_Flags Pre alert block SF Flags.
 * @param old_Ent_Flags Pre alert block Enterprise flags.
 * @return A new message on success,  NULL On failure.
 */
SO_PUBLIC extern struct Message * MessageAlertPrimary_Initialize(
    struct Event *event,
    struct Block *block,
    List_t *metadata,
 ...
 * @return A new message on success,  NULL On failure.
 */
SO_PUBLIC extern struct Message * MessageAlertChild_Initialize(
    struct Block *block,
    struct Block *child,
    struct Nugget *nugget,
 ...
 * @return A new message on success,  NULL On failure.
 */
SO_PUBLIC struct Message * MessageOutputInspection_Initialize(
    struct Nugget *nugget,
