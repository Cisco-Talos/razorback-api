...
#define MESSAGE_TYPE_CLEAR          ( MESSAGE_GROUP_CACHE | 3 ) ///< Clear Local Cache
/// @}
...
{
    struct CcMessageHeader ccmhMessageHeader;   ///< Command and Control Message Header
    struct NTLVList *ntlvConfigurationList;  ///< Configuration Items
};
...
struct MessageCacheReq
{
    ...
    struct BlockId bidBlock;    ///< Data Block ID
};
...
struct MessageCacheResp
{
    struct MessageHeader mhHeader;  ///< Message Header
    struct BlockId bidBlock;    ///< Data Block ID
    uint32_t iCode;             ///< Data block code
};
...
{
    struct MessageHeader mhHeader;  ///< Message Header
    uuid_t uuidNuggetId;        ///< Generating Nugget ID
    uuid_t uuidApplicationType; ///< The data type.
...
{
    struct MessageHeader mhHeader;  ///< Message Header
    uint32_t iDisposition;      ///< Judgment
    uuid_t uuidInspectorId;     ///< who wrote it
    uuid_t uuidApplicationId;   ///< what was the app type
 ...
 * @param p_uuidNuggetId the submitting nugget
 * @param p_uuidApplicationType the data type
