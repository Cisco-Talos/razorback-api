 ...
 */
SO_PUBLIC extern int Socket_Accept(struct Socket **socket, const struct Socket *listeningSocket);
 ...
 */
SO_PUBLIC extern ssize_t Socket_Tx(const struct Socket *socket, size_t len, const uint8_t * buffer);
 ...
 */
SO_PUBLIC PRINTF_FUNC(2,3) extern bool Socket_Printf(
 ...
 */
SO_PUBLIC extern ssize_t Socket_Rx(const struct Socket *socket, size_t len, uint8_t * buffer);
