...
extern struct List * UUID_Create_List (void);
extern bool UUID_Add_List_Entry(struct List *list, uuid_t uuid, const char *name, const char *desc);

extern struct List * UUID_Get_List(int type);
extern size_t UUIDList_BinarySize(struct List *list);
