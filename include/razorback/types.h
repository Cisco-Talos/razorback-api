...
struct BlockId
{
    ...
    uint32_t iLength;           ///< The length of the data in the block
};
...
struct Block
{
    struct BlockId bidId;       ///< Block ID
    struct BlockId *bidParent;  ///< Parent Block ID
    uint8_t *pData;             ///< Data for the Block
...
#define JUDGMENT_GOOD 0
#define JUDGMENT_BAD 1
#define JUDGMENT_ERROR 2
#define JUDGMENT_DEFERRED 3
